Å@function SqlExequteNonQuery($SqlCommand,$Server,$Database,$CommnadType){
    try{
...
>>>>>>> parent of d29023e... passÂ§âÊõ¥
=======
        $conStr["User ID"]="sa"
        $conStr["Password"]="sagawa"
>>>>>>> parent of a53ae91... ÂÖ¨ÈñãË®≠ÂÆö
...
Write-Host $result2
    ...
    Write-Host 'ÉGÉâÅ[Ç™î≠ê∂ÇµÇ‹ÇµÇΩ'
    Write-Host "ÉGÉâÅ[ì‡óeÅF$_"
    Pause
}
